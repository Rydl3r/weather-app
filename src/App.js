...
function App() {
  ...
  const fetchWeather = async () => {
    const response = await fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=473d1ee43c0e104fb437f7a5e0e8ecd4&units=metric`
    );
    setTempCity(city);
    setCity("");
      ...
      <div className="container">
        ...
        <div className="info-side">
          ...
          >
            ...
            />
            <button className="getWeatherBtn" onClick={fetchWeather}>
              Get Weather
            </button>
          </form>
        </div>
